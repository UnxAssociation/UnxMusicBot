# Here's new thumbnail for you. if you want to keep old one then read "https://te.legra.ph/UNXMUSIC-OLD-THUMBNAIL-04-01".
...
async def gen_thumb(videoid: str):
    try:
        ...
        title_font = ImageFont.truetype("UnxMusic/assets/font3.ttf", 45)
        ...
        play_icons = Image.open("UnxMusic/assets/icons.png")
